    ...
    <div className="min-h-screen bg-[#030303] flex items-center justify-center px-4 md:px-6 py-24 md:py-32 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-slate-500">Join our exclusive network</p>
        </div>

        <form onSubmit={handleRegister} className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <label className="text-[9px] uppercase tracking-[0.2em] font-bold text-slate-500 ml-1">First Name</label>
              <div className="relative group">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500 group-focus-within:text-white transition-colors" />
                <input 
                  type="text" 
                  required
                  value={firstName}
            ...
            <div className="space-y-2">
              <label className="text-[9px] uppercase tracking-[0.2em] font-bold text-slate-500 ml-1">Last Name</label>
              <div className="relative group">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500 group-focus-within:text-white transition-colors" />
                <input 
                  type="text" 
        ...
        <p className="mt-8 text-center text-slate-500 text-xs">
          Already have an account? <Link to="/login" className="text-white hover:text-blue-400 font-medium transition-colors ml-1">Log in</Link>
        </p>
      </motion.div>
    </div>
  );
